...
<script>
	require([
		...
		myStore = new Cache(JsonRest({target:"../StoreJson"}), new Memory());
		grid = new DataGrid({
			store: dataStore = new ObjectStore({objectStore: myStore}),
			structure: [
				{name:"id", field:"id", editable: true},
				{name:"capital", field:"capital",  editable: true},
				{name:"State Name", field:"name"},
